...
<div className="grid grid-cols-1 2xl:grid-cols-2 gap-5 w-full">
	<div className="min-w-0 order-2 2xl:order-1">
	##### Request Headers
...
<Td className="border-0">
	...
	<div className="min-w-0 order-1 2xl:order-2">
<CH.Code>
```json BodyData
{
...
### Dữ liệu yêu cầu trả hàng [#return-request-payload]
...
<Td className="border-0">
				...
				Chứa tiến độ hoàn trả. Sự kiện hoàn tất dùng `status: COMPLETED`; không coi `REFUNDING` là đã hoàn tất. Ghép `returnId`/`returnTrackId` với yêu cầu và `orderId`/`orderTrackId` với đơn gốc. Xem toàn bộ flow trạng thái tại [Return Request API](/api-list/return-request).
...
{
  "id": "6741ae7de65369e169a70758",
  "sentDate": "2026-09-12T08:05:00.000Z",
  ...
  "data": {
    ...
    "items": [
      {
        "orderItemId": "6740ce7f9d04259159bc6401",
